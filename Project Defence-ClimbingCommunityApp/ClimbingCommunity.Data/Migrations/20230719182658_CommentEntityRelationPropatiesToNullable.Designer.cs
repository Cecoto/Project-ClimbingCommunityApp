...
namespace ClimbingCommunity.Data.Migrations
{
    ...
    [Migration("20230719182658_CommentEntityRelationPropatiesToNullable")]
    partial class CommentEntityRelationPropatiesToNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClimbingCommunity.Data.Models.ClimbingTrip", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("85f46af9-803c-4604-8073-1e5cf7540deb"),
                        ...
                        new
                        {
                            Id = new Guid("d0a27ea7-4474-4f47-af0d-229264186e34"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("deab605b-872f-47af-ae9d-048a254f3d68"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("ClimbingCommunity.Data.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<Guid?>("ClimbingTripId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClimbingCommunity.Data.Models.TrainingClimber", b =>
                {
            ...
            modelBuilder.Entity("ClimbingCommunity.Data.Models.Comment", b =>
                {
                    b.HasOne("ClimbingCommunity.Data.Models.ApplicationUser", "Author")
                        .WithMany("Comments")
                    ...
                    b.HasOne("ClimbingCommunity.Data.Models.ClimbingTrip", "ClimbingTrip")
                        .WithMany("Comments")
                        .HasForeignKey("ClimbingTripId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ClimbingCommunity.Data.Models.Training", "Training")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("ClimbingCommunity.Data.Models.TrainingClimber", b =>
                {
                    b.HasOne("ClimbingCommunity.Data.Models.Climber", "Climber")
                        .WithMany("JoinedTrainings")
                        .HasForeignKey("ClimberId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ClimbingCommunity.Data.Models.Training", "Training")
                        .WithMany("JoinedClimbers")
                        .HasForeignKey("TrainingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
